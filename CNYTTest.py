...
class TestSuma(unittest.TestCase):
    ...
    def test_ConversionCAP(self):
        ConverCAPcomp = OperacionesComplejos.ConversionCartesianaAPolar(1,1.7320508075688774)
        self.assertAlmostEqual(ConverCAPcomp[0], 2.0)
        self.assertAlmostEqual(ConverCAPcomp[1], 60.00000000000001)
    def test_Fase(self):
        fasecomp = OperacionesComplejos.Fase((3,4))
